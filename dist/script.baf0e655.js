...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/livre.js":[function(require,module,exports) {
"use strict";
...
var Livre = /*#__PURE__*/_createClass(function Livre(titre, auteur, image) {
  var _this = this;
...
var _livre = _interopRequireDefault(require("./livre.js"));
...
form.addEventListener('submit', function (event) {
  ...
  var champTitre = document.querySelector('#titre-input');
  var champAuteur = document.querySelector('#auteur-input');
  var champImage = document.querySelector('#image-input');
  // récupérer les valeurs des champs
  var titre = champTitre.value;
  var auteur = champAuteur.value;
  var image = champImage.value;
  // créer un nouveau livre
  var newLivre = new _livre.default(titre, auteur, image);
  var NewLivre = newLivre.createNewLivre();
  // crée un bouton supprimer
  var supprimerBouton = NewLivre.querySelector("#supprimer-livre");
...
},{"./livre.js":"src/livre.js"}],"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
